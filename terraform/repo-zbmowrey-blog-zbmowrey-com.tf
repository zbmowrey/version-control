module "repo-zbmowrey-zbmowrey-com" {
  ...
  cf_distribution_develop = lookup(lookup(var.cf_distributions, "blog-zbmowrey-com", {
    zbmowrey-com = { develop = "" }
  }), "develop", "")
  cf_distribution_main    = lookup(lookup(var.cf_distributions, "blog-zbmowrey-com", {
    zbmowrey-com = { develop = "" }
  }), "main", "")
  cf_distribution_staging = lookup(lookup(var.cf_distributions, "blog-zbmowrey-com", {
    zbmowrey-com = { develop = "" }
  }), "staging", "")
